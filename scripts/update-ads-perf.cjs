...
/* ТРЕТИЙ ФОРМАТ ИМЕНИ — «2026-09-11» С ДЕФИСАМИ (появился 14.09.2026). XWAY переименовал
   ...
   («…-_2026-09-17_-_2026-09-17.xlsx»), а между «_» и «2» границы слова НЕТ — дата не находилась
   и скрипт падал с «не понял период». Смотрим на соседние ЦИФРЫ, а не на границу слова. */
