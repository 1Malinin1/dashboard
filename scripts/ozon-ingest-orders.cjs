...
for(const f of files){
  ...
  /* ВТОРАЯ ЦЕНА — «Оплачено покупателем». Копим СПРАВОЧНО, для сверки с будущим финотчётом
     Ozon. ВЫРУЧКОЙ ЕЁ СЧИТАТЬ НЕЛЬЗЯ (проверено 08.09.2026):
       · это сумма ОТПРАВЛЕНИЯ — в смешанном отправлении стоит на каждой строке целиком
         (07.09 арт. 487176: предельная 6 332 ₽, «оплачено» 26 813 ₽);
       · не включает оплату баллами Ozon (24.08 арт. 487192: толокар 1 857 ₽ при 52,64 ₽);
       · разрыв с потолком НЕ новый — 68,7–72,6% и до 31.08, и после, то есть к смене
         методики 31.08 отношения не имеет.
     Что реально изменилось 31.08 — воронка Ozon перешла на «цену реализации» (70,7–75,2%
     от потолка при совпадающих штуках). Наш ряд заказов остаётся на потолке до финотчёта. */
